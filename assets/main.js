...
const traffic = [
    ...
    new Car(road.getLaneCenter(4), -400, 30, 50, "DUMMY", 2, getRandomColor()),
    ...
    new Car(road.getLaneCenter(4), -800, 30, 50, "DUMMY", 2, getRandomColor()),
    ...
    new Car(road.getLaneCenter(4), -1300, 30, 50, "DUMMY", 2, getRandomColor()),
];

animate();

//SAVING THE BRAIN TO LOCAL STORAGE
function save() {
